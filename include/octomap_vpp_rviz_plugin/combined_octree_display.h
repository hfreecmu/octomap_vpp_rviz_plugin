#ifndef COMBINED_OCTREE_DISPLAY_H
#define COMBINED_OCTREE_DISPLAY_H
...
class CombinedOcTreeDisplay : public octomap_rviz_plugin::OccupancyGridDisplay
{
Q_OBJECT
public:
  CombinedOcTreeDisplay();
protected:
  void incomingMessageCallback(const octomap_msgs::OctomapConstPtr& msg);
  void setVoxelColor(rviz::PointCloud::Point& newPoint, octomap_vpp::CombinedOcTreeNode& node, double minZ, double maxZ);
